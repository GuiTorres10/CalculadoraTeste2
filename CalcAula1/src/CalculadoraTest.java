...
public class CalculadoraTest {
    ...
    public static void main(String[] args) {
       Calculadora calc = new Calculadora();
        ...
        //Cenário de teste  20: Divisão de dois valores
        double div = calc.dividir(10, 2);
        System.out.println(div);
        
        //Cenário de teste  21: Divisão de dois valores sendo um zero
        div = calc.dividir(1, 0);
        System.out.println(div);
        
        //Cenário de teste  22: Divisão de dois valores sendo que ambos são zero
        div = calc.dividir(0, 0);
        System.out.println(div);
        
        //Cenário de teste  23: Divisão de dois valores sendo um negativo
        div = calc.dividir(-12, 4);
        System.out.println(div);
        
        //Cenário de teste  24: Divisão de dois valores sendo um número quebrado
        div = calc.dividir(2.5, 2);
        System.out.println(div);
       
        //Cenário de teste  25: Divisão de dois valores sendo ambos números quebrados
